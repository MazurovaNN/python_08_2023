...
# python my_script.py John subjects.csv - запускаю из командной строки
# Здесь теперь my_script.py - имя файла со скриптом, John - это имя студента, 
# subjects.csv - имя CSV-файла с учебными предметами.